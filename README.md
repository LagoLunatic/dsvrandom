...
Source code will be here: https://github.com/appleforyou/dsvrandom-rv - however that is currently incomplete. 
For the time being I've repackaged LagoLunatic's 1.3.0 release with my new files.
